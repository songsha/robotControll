...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
   ...
   _slidView=[[SSSlideView alloc]initWithFrame:CGRectMake(0, 0, SCREENW-70, SCREENH)];
//    view.backgroundColor=[UIColor blueColor];
//    UITapGestureRecognizer * tap=[[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(move)];
//    [view addGestureRecognizer:tap];
    [self.window addSubview:_slidView];
    
    
    
    SSLoginViewController * main=[[SSLoginViewController alloc]init];
